      ...
      <Container style={{backgroundColor:'#ffffff'}}>
        ...
        <Content style={styles.content}>
          <Form>
            ...
            <Item stackedLabel disabled style={styles.itemForm}>
              <Label>Address</Label>
              <Input multiline={true} value="Jl. Boulevard Six" style={{paddingVertical: 15}}/>
            </Item>
            <Item stackedLabel disabled style={styles.itemForm}>
            ...
            <Item stackedLabel disabled style={styles.itemForm}>
              ...
              <Input multiline={true} value="Jl. Tikungan Dua" style={{paddingVertical: 15}}/>
            </Item>
          </Form>
          <View style={styles.buttonView}>
            <Button primary style={styles.buttonBack} onPress={() => this.props.navigation.navigate('AddCustomer')}>
              <Text style={styles.buttonText}>BACK</Text>
            </Button>
            <Button primary style={styles.button} onPress={() => this.props.navigation.navigate('Activity')}>
              <LinearGradient 
