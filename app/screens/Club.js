...
import { StyleSheet, TouchableOpacity, TouchableHighlight, Dimensions, FlatList, TouchableNativeFeedback } from 'react-native'
import { Container,
Content,
Header,
Left,
...
class Club extends Component {
      ...
      dataJoker: [
        {
          ...
          avatar: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSv7w-iiNlrMPb2rAFRiPxpTsD6ab9rj7SdbVNv2jqyx-ces0xb'
        },
        {
          title: "PT Tele Digital Kreatif",
          person: "Muhammad Fuadit",
          description: "0RS-05-33D-Xerox",
          avatar: 'https://media.licdn.com/media-proxy/ext?w=800&h=800&hash=iNhNmsHQG4hyGxyWFupYOY2%2FzJ8%3D&ora=1%2CaFBCTXdkRmpGL2lvQUFBPQ%2CxAVta5g-0R6nlh8Tw1Ek-L7T40O550NJC4HTDy_8DnHzq8jAIiihMNiKMfau41AUfikIhlw_fe2rQia3H82qc9usJdFyi8-sLcu1NhMcUU8A3Wxb2_QuFTMdkZanCbO1MwoI3f5ZMH74YZroQXAcPh0z9t6EPaD0e1EH6GOqb-jQXJ5mRpZU5IAPxBMFlZvVGNII_d1iw2E_41uM7p_jY20957CYBAKKJVsdBkbKKuZW6pu__Aa8wnvMrWb5iKeHXZirMIgXmlCk1s6KckrQ3ktivG4lyyFNg95KE1iA2NlN6W_nDeZfRQ'
        },
        {
  ...
  renderItems = ({item}) => (
    <TouchableOpacity>
      <HorizontalJoker title={item.title} person={item.person} description={item.description} avatar={item.avatar} />
    </TouchableOpacity>
  )
  ...
  renderItemUsers = ({item, index}) => (
    <View style={{display: 'flex', flexDirection: 'row', marginTop: 30, alignItems: 'center'}}>
      ...
      {(item.avatar === '' ? (
        ...
        <Thumbnail small source={{uri: item.avatar}} style={{marginRight: 10}}/>
      ))}
      <View>
              ...
              <Col style={styles.leftCol}>
                <View style={styles.headerDirection}>
                  ...
                  <View>
                    ...
                    <View style={styles.headerDirection}>
                      <Text style={styles.Data}>{this.props.sessionPersistance.data.bio}</Text>
                    </View>
                    <View style={styles.headerDirection}>
        ...
        <View style={styles.content}>
          <View style={styles.boardDirection}>
            <View style={styles.leaderboard}>
              <Text style={styles.leaderboardTitle}>{this.props.sessionPersistance.data.regionals[0].region} Leaderboard</Text>
              <FlatList 
                data={this.props.users.filter(u => u.id_region === this.props.sessionPersistance.data.regionals[0].id_region).slice(0, 5)}
