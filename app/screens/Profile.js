...
class Profile extends Component {
  ...
  componentWillMount() {
    this.props.getUserRegionRank(this.props.users, this.props.sessionPersistance.data.regionals[0].id_region)
    this.props.getUserNationRank(this.props.users, this.props.sessionPersistance.data.id)
  }
  ...
  renderForeground(){
    return(
      ...
      <Image style={ styles.avatar } source={{
        uri: 'https://www.timeshighereducation.com/sites/default/files/byline_photos/default-avatar.png',
        width: AVATAR_SIZE,
        height: AVATAR_SIZE
      }}/>
        ...
        <Col style={styles.fixHeaderRight}>
          <View key="fixed-header" style={styles.fixedSection}>
            <TouchableOpacity onPress={() => this.props.navigation.navigate('Settings')}>
              <Icon name="ios-settings" size={25} color="#fff" style={styles.iconSetting} />
            </TouchableOpacity>
            <TouchableOpacity onPress={() => this.props.navigation.navigate('Notifications')}>
              <Icon name="ios-notifications" size={25} color="#fff" style={styles.iconBell} />
            </TouchableOpacity>
          </View>
        </Col>
      </Grid>
          ...
          <View style={styles.profileInfoView}>
            ...
            <Form>
              ...
              <Item stackedLabel disabled style={styles.itemForm}>
                ...
                <Input disabled placeholder={(data.gender === 1) ? 'Male' : 'Female'}/>
              </Item>
              <Item stackedLabel disabled style={styles.itemForm}>
              ...
              <Item stackedLabel disabled style={styles.itemForm}>
                ...
                <Input disabled placeholder={JSON.stringify(this.props.userRegionRank.findIndex(i => i.id === data.id) + 1)}/>
              </Item>
              <Item stackedLabel disabled style={styles.itemForm}>
                <Label style={styles.labelText}>National Rank</Label>
                <Input disabled placeholder={JSON.stringify(this.props.userNationRank)}/>
              </Item>
            </Form>
          </View>
      </ParallaxScrollView>
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    getUserNationRank: (data, id_region) => dispatch(getUserNationRank(data, id_region)),
